...
class CupertinoColors {
  ...
  static const CupertinoDynamicColor detailGray = CupertinoDynamicColor.withBrightness(
    debugLabel: 'detailGray',
    color: Color.fromRGBO(60, 60, 67, 0.6),
    darkColor: Color.fromRGBO(235, 235, 245, 0.6),
  );

  static const CupertinoDynamicColor infoBlue = CupertinoDynamicColor.withBrightness(
    debugLabel: 'infoBlue',
    color: Color(0xFF007AFF),
    darkColor: Color(0xFF0A84FF),
  );

  static const CupertinoDynamicColor cellBackground = CupertinoDynamicColor.withBrightness(
    debugLabel: 'cellBackground',
    color: Color(0xFFFFFFFF),
    darkColor: Color.fromARGB(255, 26, 26, 28),
  );

  static const CupertinoDynamicColor errorRed = CupertinoDynamicColor.withBrightness(
    debugLabel: 'errorRed',
    color: Color.fromARGB(255, 255, 59, 48),
    darkColor: Color.fromARGB(255, 255, 85, 73),
  );

  static const CupertinoDynamicColor searchBackground = CupertinoDynamicColor.withBrightness(
    debugLabel: 'searchBackground',
    color: Color.fromRGBO(224, 224, 226, 0.73),
    darkColor: Color.fromARGB(255, 44, 44, 46),
  );

  static const CupertinoDynamicColor textfieldBackground = CupertinoDynamicColor.withBrightness(
  ...
  static const CupertinoDynamicColor systemGroupedBackground = CupertinoDynamicColor(
    ...
    color: Color.fromARGB(255, 242, 242, 247),
    darkColor: Color.fromARGB(255, 4, 4, 6),
    highContrastColor: Color.fromARGB(255, 235, 235, 240),
    darkHighContrastColor: Color.fromARGB(255, 0, 0, 0),
    elevatedColor: Color.fromARGB(255, 242, 242, 247),
    darkElevatedColor: Color.fromARGB(255, 28, 28, 30),
