...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextThemeData textTheme = themeData.textTheme;
    ...
    final Color selectedColor = labelColor ?? themeData.primaryColor;
    final Color unselectedColor = unselectedLabelColor ??
        Colors.inactiveGray.resolveFrom(context) ??
...
class _TabBarState extends State<TabBar> {
  ...
  Decoration get _indicator {
    ...
    Color color = widget.indicatorColor ?? CupertinoTheme.of(context).primaryColor;
...
class TabPageSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color fixSelectedColor = selectedColor ?? CupertinoTheme.of(context).primaryColor;
